...
| :--- | :--- | :--- | :--- |
| **Phase 0** | Relational Micro-ERP Architecture | **Fully Corrected & Awaiting Sign-off** | Integrated User Management CRUD (Admin only), Public Client Checkout (`solicitar_pedido.php`), Local Image Uploads (`/uploads`), Navbar Login Modal, and Orphaned File Deletion Policy (`unlink()`) across bilingual documentation. |
