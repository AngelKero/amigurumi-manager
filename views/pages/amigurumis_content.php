...
<section class="card border-0 shadow-sm mb-4 card-stitched" style="border-radius: var(--craft-radius); background-color: #FFFFFF;">
  <div class="card-body p-3 p-md-4">
    ...
    <div class="row g-3 align-items-center mb-3">
      <div class="col-12 col-md-7 col-lg-8">
        <div class="input-group">
          ...
          <input type="text" id="searchAmigurumiInput" class="form-control border-start-0" placeholder="Buscar por nombre, material o técnica..." style="border-top-right-radius: var(--craft-radius-pill); border-bottom-right-radius: var(--craft-radius-pill);">
        </div>
      </div>
      <div class="col-12 col-md-5 col-lg-4 d-flex justify-content-md-end align-items-center gap-2">
        <span class="badge badge-textile-tag" id="amigurumisCountBadge">
          <i class="bi bi-box2-heart me-1"></i><?= count($amigurumisList) ?> piezas
        </span>
        <button type="button" id="btnResetAmigurumiFilters" class="btn btn-craft-outline btn-craft-outline-stitched btn-sm d-inline-flex align-items-center gap-1">
    ...
    <div class="row g-2 g-md-3">
      ...
      <!-- Ordenación -->
      <div class="col-12 col-sm-6 col-md-3">
        <label for="sortAmigurumisSelect" class="form-label small text-muted fw-bold text-uppercase mb-1" style="font-size: 0.7rem; letter-spacing: 0.04em;">Ordenar por</label>
        <select id="sortAmigurumisSelect" class="form-select select-craft-pill">
...
<div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 g-3 g-xl-4 mb-4" id="amigurumisGrid">
  ...
  <div class="col"
    ...
    <div class="card card-admin-amigurumi card-stitched h-100 border-0 shadow-sm">
...
<div id="emptyAmigurumisState" class="d-none text-center py-5 p-4 card border-0 shadow-sm card-stitched" style="border-radius: var(--craft-radius); background: #FFFFFF;">
  <div class="mb-3">
