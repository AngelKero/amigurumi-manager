<?php
/**
 * Component: Modal Inspect Amigurumi (Algodón Nórdico)
 * Detailed technical and financial inspection dialog for amigurumis.
 */
?>
<div class="modal fade" id="modalInspectAmigurumi" tabindex="-1" aria-labelledby="modalInspectAmigurumiTitle" aria-hidden="true">
        ...
        <div class="row g-4">
          ...
          <div class="col-12 col-md-5 text-center">
            <div class="p-3 bg-light rounded border mb-3 d-flex align-items-center justify-content-center" style="min-height: 220px; border-radius: var(--craft-radius-sm);">
              <div id="inspectAmigurumiImageContainer" class="w-100">
                <?= svg('amigurumis/dragon-ignis', ['class' => 'img-fluid', 'style' => 'max-height: 180px;']) ?>
              </div>
            </div>
