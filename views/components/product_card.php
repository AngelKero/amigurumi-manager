    ...
    <div class="card-body d-flex flex-column p-4" style="position: relative; z-index: 2;">
      ...
      <div class="artisan-card-actions d-none pt-2 mt-2 border-top d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group btn-group-sm">
          <a href="formulario.php?id=<?= $item['id'] ?>" class="btn btn-outline-secondary btn-sm py-0 px-2" aria-label="Editar creación">
            <i class="bi bi-pencil-square"></i>
          </a>
          <button type="button" class="btn btn-outline-danger btn-sm py-0 px-2 btn-card-delete" data-bs-toggle="modal" data-bs-target="#modalEliminarCreacion" data-id="<?= $item['id'] ?>" data-name="<?= htmlspecialchars($item['nombre']) ?>" aria-label="Eliminar del catálogo">
